...
<template>
  ...
  <template v-if="iconName === 'identity'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        :width="props.w || 24"
  ...
  <template v-if="iconName === 'configure'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        :width="props.w || 24"
  ...
  <template v-if="iconName === 'settings'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        :width="props.w || 24"
  ...
  <template v-if="iconName === 'info-circle'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        :width="props.w || 24"
  ...
  <template v-if="iconName === 'chev-down'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        :width="props.w || 24"
  ...
  <template v-if="iconName === 'chev-up'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  <template v-if="iconName === 'rocket-takeoff'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        :width="props.w || 24"
  ...
  <template v-if="iconName === 'eye-slash'">
    <span :class="props.classname">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        :width="props.w || 24"
